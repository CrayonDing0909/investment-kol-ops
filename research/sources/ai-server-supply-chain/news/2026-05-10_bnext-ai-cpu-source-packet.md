...
ticker: n/a
source_class: news
source_quality: secondary+primary-addendum
status: draft
---
...
- Primary addendum: Georgia Tech / Intel original research paper
...
- Original Georgia Tech / Intel paper supports the direction of this claim, but with workload-specific wording: tool-dominated workloads can spend up to 88% of end-to-end latency in CPU-side tool processing; RAG retrieval, web summarization, and SWE-Agent Bash/Python execution have different latency ranges.
...
| up to 88 | % latency | CPU-side tool processing share | selected tool-dominated workloads | Original paper: tool processing on CPU consumes up to 88% of E2E latency |
...
- "Tool dominated agentic AI workloads are significantly bottle-necked by tool processing on the CPU consuming up to 88% of the end-to-end latency." — Georgia Tech / Intel paper.
...
- The Georgia Tech + Intel research paper has now been collected as a primary source addendum. Use the paper for public quantitative latency wording, and use BusinessNext mainly for Chinese-language framing.
...
- Original paper source packet: `research/sources/ai-server-supply-chain/papers/2026-05-12_agentic-ai-cpu-centric-source-packet.md`
